...
DEFAULT_TEAM_CHECKLIST_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "Automation / Data": {
        "planning": "Define workflow automation requirements, trigger schedules, and data validation rules",
        "setup": "Configure automation script environment, document parsers, and data source connectors",
        "testing": "Verify parsing accuracy, exception handling for anomalies, and notification triggers",
        "deployment": "Deploy scheduled job execution and configure operations alert routing",
        "supporting": "Deliver clean data outputs and automated ingestion webhooks for downstream teams",
    },
    "Data Engineering": {
